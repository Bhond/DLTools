...
public class VertxServerRequestHandler extends RequestHandler {
     ...
     *
     *****************************************/
    private NetSocket currentNetSocket;
     ...
     * Nothing to be done
     */
    private VertxServerRequestHandler(){
        // Nothing to be done
    }
     ...
     */
    public VertxServerRequestHandler(VertxServer server){
        this.server = server;
    }
     ...
     * @param socket The socket of the client sending the request
     * @param request The request to be handled
     */
    public void handle(NetSocket socket, Request request){
        this.currentNetSocket = socket;
     ...
     * @param request The request to be handled
     */
//    public void handle(NetSocket socket, Buffer request){
//        this.currentNetSocket = socket;
//        super.handle(request);
//    }
    ...
    private void authenticateHandling(AuthenticateRequest request){
        ...
        this.server.addClient(id, this.currentNetSocket);
    ...
    private void disconnectionHandling(DisconnectionRequest request){
        long id = request.getClientId();
        this.server.removeClient(id, this.currentNetSocket);
